...
const DeleteVersionModal: React.FC<DeleteVersionModalProps> = ({ onCancel, onConfirm, versionName }) => {
  return (
      ...
      >
        ...
        <div className="py-3 pr-2 pl-6 w-full">
          <div className="flex justify-between items-center">
            <h2 className="text-[var(--neutral-light-for-white-bg-neutral-1200, #192839)] font-[Noto_Sans] text-lg font-bold leading-[26px]">Delete {versionName} ?</h2>
        ...
        <div className="px-6 pt-4 border-t w-full">
          <p className="self-stretch text-[var(--neutral-light-for-white-bg-neutral-1200, #192839)] font-[Noto_Sans] text-[14px] font-normal leading-6">
            This will permanently remove {versionName} from the version history. Other versions will stay the same. The version numbers will not change.
          </p>
        </div>
        {/* Footer */}
