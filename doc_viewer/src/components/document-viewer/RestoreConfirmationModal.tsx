...
const RestoreConfirmationModal: React.FC<RestoreConfirmationModalProps> = ({ onCancel, onConfirm, versionName }) => {
  return (
      ...
      >
        ...
        <div className="py-3 pr-2 pl-6 w-full">
          <div className="flex justify-between items-center">
            <h2 className="text-[var(--neutral-light-for-white-bg-neutral-1200, #192839)] font-[Noto_Sans] text-lg font-bold leading-[26px]">Restore {versionName} ?</h2>
        ...
        <div className="px-6 pt-4 border-t w-full">
          <p className="self-stretch text-[var(--neutral-light-for-white-bg-neutral-1200, #192839)] font-[Noto_Sans] text-[14px] font-normal leading-6">
            You're currently working on Version {versionName}. If you restore {versionName},
            <br />
            the system will create a new Version {parseInt(versionName.slice(1)) + 1} based on it.
            <br />
            Don't worry all your previous versions will still be saved.
          </p>
        </div>
        {/* Footer */}
