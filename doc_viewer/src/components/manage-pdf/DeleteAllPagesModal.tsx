...
interface DeleteAllPagesModalProps {
    show: boolean;
    onCancel: () => void;
    onConfirm: () => void;
}

const DeleteAllPagesModal: React.FC<DeleteAllPagesModalProps> = ({ show, onCancel, onConfirm }) => !show ? null : (
        ...
        >
            ...
            <div className="p-2 pl-6 w-full">
                <div className="flex justify-between items-center">
                    <h2 className="text-[var(--neutral-light-for-white-bg-neutral-1200, #192839)] font-[Noto_Sans] text-lg font-bold leading-[26px]">Delete Pages?</h2>
            ...
            <div className="px-6 pt-4 border-t w-full">
                <p className="self-stretch text-[var(--neutral-light-for-white-bg-neutral-1200, #192839)] font-[Noto_Sans] text-[14px] font-normal leading-6">
                    You're about to delete all pages in this file.
                    <br />
                    This will permanently delete the file from the system.
                </p>
            </div>
            {/* Footer */}
            <div className="flex w-full justify-end gap-3 p-6">
                <Button
                    onClick={onCancel}
                    style={{
                        display: 'flex',
